...
def test_cluster_has_conversations(mock_explorer):
    ...
    for cluster in clusters:
        ...
        assert cluster.chat_ids is not None, f"Cluster {cluster.id} has no chat_ids field"
...
def test_cluster_frontend_display(client):
    ...
    for cluster in clusters:
        ...
        assert 'conversation_count' in cluster, "Cluster missing conversation_count field"